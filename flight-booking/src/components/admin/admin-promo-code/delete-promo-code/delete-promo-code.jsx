...
const DeletePromoCode = ({ promoCode, onClose, onSuccess }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            await axiosApi.delete(`/promo-codes/${promoCode.id}`);
            onSuccess();
        } catch (err) {
    ...
    return (
        <div className="delete-component-container">
            <div className="delete-component-header">
                <h3 className="delete-component-title">Delete Promo Code</h3>
                <button
                    onClick={onClose}
            ...
            <div className="space-y-4">
                ...
                <p className="delete-component-message">
                    Are you sure you want to delete promo code <strong>{promoCode?.code}</strong>? <br /> 
