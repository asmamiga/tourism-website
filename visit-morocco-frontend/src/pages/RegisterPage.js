...
const registerImage = '/images/login-bg-new.jpg';
  ...
  return (
    <Container maxW="container.xl" py={16}>
      ...
      >
        ...
        {/* Right side - Form */}
        <Box flex="1" p={{ base: 6, md: 10 }} maxW={{ lg: '600px' }} w="100%" overflowY="auto">
          <VStack spacing={6} align="stretch">
            <Box>
              ...
              <Text color="gray.600">
                Join our community to explore the best of Morocco
              </Text>
            </Box>
